      ...
      <div class="col-12">
        ...
        <div class="box">
          <div class="box-header with-border">
            <h3 class="box-title">Word Data Table</h3>
            ...
            <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive w-p100">
              ...
              <tbody>
                ...
                foreach ($words as $key => $value) {
                  ...
                  $exBasic = $value["example_basic"];
                  $exRevi = $value["example_revision"];
                  $cDate = $value["createdOn"];
                  $action = "<a class=\"btn btn-block btn-warn btn-lg\" href=\"word.php?id=".$value["id"]."\">
                  ...
                  <tr>
                    ...
                    <td><?php echo $exBasic; ?></td>
                    <td><?php echo $exRevi; ?></td>
